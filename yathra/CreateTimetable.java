...
public class CreateTimetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //EditText routeName = (EditText) findViewById(R.id.editTextRoutNameCT);
    ...
    public void insertTimetable(View view) {
        ...
        //validation(name, aTime,dTime, date, tName);

        if(validation(name, aTime,dTime, date, tName) == true) {
            ...
            Toast.makeText(this, "All Field have to Filed!", Toast.LENGTH_SHORT).show();
        }

    }

    private boolean validation(String name, String date, String aTime, String dTime, String tName){
        if(name != null || date != null || aTime != null || dTime != null || tName != null ){
            return true;
        }else{
            return false;
        }
